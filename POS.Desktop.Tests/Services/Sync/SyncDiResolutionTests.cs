...
public sealed class SyncDiResolutionTests
{
    ...
    public void DesktopHostBuilder_RegistersSyncOptionsAndClientSuccessfully()
    {
        ...
        var statusService = sp.GetRequiredService<ISyncStatusService>();
        ...
        Assert.IsType<EfSyncStatusService>(statusService);
        ...
        Assert.Equal(5, processorOptions.MaxRetryAttempts);
