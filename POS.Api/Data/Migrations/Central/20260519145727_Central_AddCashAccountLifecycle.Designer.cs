...
namespace POS.Api.Data.Migrations.Central
{
    ...
    [Migration("20260519145727_Central_AddCashAccountLifecycle")]
    partial class Central_AddCashAccountLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.CashAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "IsActive", "AccountType")
                        .HasDatabaseName("IX_CashAccounts_Tenant_Active_Type");

                    b.HasIndex("TenantId", "LocationId", "AccountType")
                        .HasDatabaseName("IX_CashAccounts_Tenant_Location_Type");

                    b.ToTable("CashAccounts", (string)null);
                });

            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.CashAccountMovement", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<int?>("DestinationCashAccountId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "DestinationCashAccountId")
                    ...
                    b.HasIndex("TenantId", "PerformedByEmployeeId");
                    ...
                    b.HasIndex("TenantId", "VerifiedByEmployeeId", "BusinessDate")
                        .HasDatabaseName("IX_CashAccountMovements_Tenant_VerifiedBy_Date");

                    b.ToTable("CashAccountMovements", (string)null);
                });
            ...
            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.ItemVariant", b =>
                {
                    ...
                    b.HasIndex("TenantId", "WeightUnitOfMeasureId")
            ...
            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.ManagerAction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "ActionType", "BusinessDate")
                    ...
                    b.ToTable("ManagerActions", (string)null);
                });
            ...
            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.TerminalSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TerminalSessions", (string)null);
                });
            ...
            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.CashAccountMovement", b =>
                {
                    ...
                    b.HasOne("POS.Shared.Domain.Entities.Central.CashAccount", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "DestinationCashAccountId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("POS.Shared.Domain.Entities.Central.Employee", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "PerformedByEmployeeId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("POS.Shared.Domain.Entities.Central.CashAccount", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "SourceCashAccountId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("POS.Shared.Domain.Entities.Central.Employee", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "VerifiedByEmployeeId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("POS.Shared.Domain.Entities.Central.ItemVariant", b =>
                {
                    ...
                    b.HasOne("POS.Shared.Domain.Entities.Central.UnitOfMeasure", null)
                        .WithMany()
                        .HasForeignKey("TenantId", "WeightUnitOfMeasureId")
                        .HasPrincipalKey("TenantId", "Id")
                        .OnDelete(DeleteBehavior.Restrict);
                });
